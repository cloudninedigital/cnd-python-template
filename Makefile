...
install:          ## Install the project in dev mode.
	...
	$(ENV_PREFIX)pip install --extra-index-url https://europe-west4-python.pkg.dev/cloudnine-digital/cnd-tools-repo/simple -e .[test]
...
virtualenv:       ## Create a virtual environment.
	...
	@./.venv/bin/pip install --extra-index-url https://europe-west4-python.pkg.dev/cloudnine-digital/cnd-tools-repo/simple -e .[test]
	@echo
